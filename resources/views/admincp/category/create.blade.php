                            ...
                            <div class="position-center">
                                <form action="{{route('category.store')}}" method="POST"/>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="meta_keywords" class="form-control"  aria-describedby="emailHelp">
                                        @error('meta_keywords')
                                        <span style="color: red">{{ $message }}</span>
                                          @enderror
                                      </div>
                                      <div class="mb-3">
                                        ...
                                        <input type="text" name="meta_title" class="form-control"  aria-describedby="emailHelp">
                                        @error('meta_title')
                                        <span style="color: red">{{ $message }}</span>
                                          @enderror
                                      </div>
