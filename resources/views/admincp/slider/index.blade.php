      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img style="height: 40px" src="{{ asset('image/slider/'.$item->image) }}" alt=""></td>
            ...
            <td>
                <a href="{{route('slider.edit',$item->id)}}" class="active" ui-toggle-class=""><i class="fa-solid fa-pen-to-square"></i></a>
              </td>
            <td>
